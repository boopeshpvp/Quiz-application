        ...
        <>
            <Card style={{ width: '60%', margin: 'auto' }} className='shadow-lg p-5'>
                <Card.Body className='border-bottom-none' style={{ height: '25vh' }}>
                    ...
                    <Card.Text>
                        Question No. {currqus} of 10
                        <ProgressBar variant="warning" animated now={(10 - currqus) * 11.25} style={{ height: '7px', marginTop: '1rem', marginBottom: '1rem' }} />
                    </Card.Text>
                ...
                <Card.Body className='d-flex justify-content-center h-auto'>
                    ...
                    {
                        <Button variant="outline-success" className='fw-bold' onClick={() => nextBtn(radioval)} >{currqus < 10 ? 'Next' : 'Submit'}</Button>
                    }
